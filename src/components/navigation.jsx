...
export default function Navigation() {
  return (
    <div className="fixed right-5 left-5 bottom-2 text-center z-10 lg:translate-y-[-50%] lg:top-[50%] lg:left-auto lg:right-5">
      <div className="flex flex-row justify-between lg:flex-col mx-auto bg-transparent text-secondary p-2 rounded-full border-secondary border-solid border-[2px] max-w-[200px]">
        <Link
          to="home"
