  ...
  return (
    <div id="education" className="section ">
      <div className="container mx-auto max-w-[1200px] p-2 lg:mb-[100px] lg:mt-[-80px]">
        <h4 className="text-secondary font-secondary font-semibold text-[24px] text-center mb-[20px]">
        ...
        <div className="flex flex-col lg:flex-row jusstify-between gap-4 ">
          <div className="backdrop-blur-md bg-white/30 p-[24px] rounded-xl shadow-xl">
            <h5 className="text-gradient font-secondary text-[24px] font-semibold text-center">
              Formal Education
            </h5>
            <div className="font-semibold font-third mt-4 ">
              <h6 className="text-blue-900 text-[18px]">
                Master of Management (Islamic Finance)
              </h6>
              <li className="text-slate-600 text-[15px]">
                Indonesia Banking School (Jakarta)
              </li>
              <li className="text-slate-600 text-[15px]">Graduate in 2021</li>
            </div>
            <div className="font-semibold font-third m-2 my-[20px]">
              ...
              <li className="text-slate-600 text-[15px]">Graduate in 2015</li>
            </div>
          </div>
